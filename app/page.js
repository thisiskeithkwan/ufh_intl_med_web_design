  ...
  return (
    <div className="font-sans">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-[#4169E1] p-8 relative">
              <h1 className="text-4xl font-bold mb-6 text-white">链接全球顶级癌症诊疗资源</h1>
              <p className="text-xl mb-8 text-white">
                和睦家国际医疗提供一站式解决方案<br/>
                助你寻求全球肿瘤治疗最佳方案以及资源
              </p>
              <button className="bg-white text-[#4169E1] px-6 py-3 rounded-full font-semibold">
                咨询我们的医疗顾问
              </button>
            </div>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="bg-[#4169E1] p-8">
            <h2 className="text-3xl font-bold mb-6 text-white">全球肿瘤专家网络</h2>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white p-8">
              <h2 className="text-4xl font-bold mb-8 text-[#4169E1]">全程诊疗支持配套</h2>
              <p className="text-lg mb-6 text-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                icon: Plane,
                details: ["快速医疗签证办理", "国际医疗机构直接预约", "全程医疗翻译陪同", "跨境医疗保险协调"]
              },
              {
                title: "药品采购",
      ...
      <div className="bg-gray-100 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-[#4169E1] mb-12 text-center">尊贵礼宾服务</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white p-8">
              <img 
